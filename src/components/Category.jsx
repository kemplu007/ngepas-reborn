        ...
        <div className="flex snap-x snap-mandatory gap-4 overflow-x-auto pb-4 hide-scrollbar md:grid md:grid-cols-5 md:overflow-visible md:pb-0">
          ...
          {categoryItems.map((item) => {
            ...
            return (
              <div 
                key={item.id} 
                className="group flex min-w-[100px] snap-center cursor-pointer flex-col items-center justify-center rounded-2xl bg-white p-5 shadow-sm border border-slate-100 transition-all duration-300 hover:-translate-y-1 hover:border-green-200 hover:shadow-md"
              >
                {/* Wadah Ikon */}
                <div className="mb-3 flex h-14 w-14 items-center justify-center rounded-xl bg-slate-50 text-slate-700 transition-colors duration-300 group-hover:bg-green-50 group-hover:text-green-600">
